...
- [Surveys, Conferences, Tutorials & Resources](#surveys-conferences-tutorials--resources)
  - [Search Surveys](#search-surveys)
  - [Recommender System Surveys](#recommender-system-surveys)
...
- [1. Query & User Understanding](#1-query--user-understanding)
  - [Query Understanding](#query-understanding)
  - [Search Intent Understanding](#search-intent-understanding)
  - [Query Expansion & Reformulation](#query-expansion--reformulation)
  - [Query Suggestion & Recommendation](#query-suggestion--recommendation)
  - [User Modeling & Preference Understanding](#user-modeling--preference-understanding)
  - [Personalization](#personalization)
  - [Context & Session Understanding](#context--session-understanding)
  - [Multilingual Search](#multilingual-search)
  - [Multimodal Search Understanding](#multimodal-search-understanding)

- [2. Retrieval & Candidate Generation](#2-retrieval--candidate-generation)
  - [Retrieval](#retrieval)
  - [Hybrid Search](#hybrid-search)
  - [Vector Search](#vector-search)
  - [Generative Retrieval](#generative-retrieval)
  - [Embedding Models](#embedding-models)
    - [Embedding Model Evaluation](#embedding-model-evaluation)
    - [Embedding Optimization & Compression](#embedding-optimization--compression)
  ...
  - [Knowledge Graphs & GraphRAG](#knowledge-graphs--graphrag)
  - [Document Understanding](#document-understanding)
  - [Time-Aware Search & Retrieval](#time-aware-search--retrieval)
  - [Multimodal Retrieval](#multimodal-retrieval)

- [3. Ranking & Relevance](#3-ranking--relevance)
  - [Search Ranking](#search-ranking)
  - [Reranking](#reranking)
  - [LLM-based Ranking](#llm-based-ranking)
  - [Reasoning-based Reranking](#reasoning-based-reranking)
  - [Classical Bi-Encoder & Cross-Encoder Ranking](#classical-bi-encoder--cross-encoder-ranking)
  - [Personalized Ranking](#personalized-ranking)
  - [Multimodal Ranking](#multimodal-ranking)
  - [Relevance Modeling & Feedback](#relevance-modeling--feedback)

- [4. Search Assistance & Information Seeking](#4-search-assistance--information-seeking)
  - [Autocomplete & Query Suggestion](#autocomplete--query-suggestion)
  - [Search Clarification](#search-clarification)
  - [Query Recommendation](#query-recommendation)
  - [Query Refinement](#query-refinement)
  - [Search Result Refinement](#search-result-refinement)
  - [Facets & Guided Search](#facets--guided-search)
  - [Proactive Search Assistance](#proactive-search-assistance)
  - [Search Assistance Agents](#search-assistance-agents)
  - [Exploratory Search](#exploratory-search)

- [5. Conversational & Multi-Turn Search](#5-conversational--multi-turn-search)
  - [Conversational Search](#conversational-search)
  - [Multi-Turn Search](#multi-turn-search)
  - [Conversational Query Reformulation](#conversational-query-reformulation)
  - [Contextual Retrieval](#contextual-retrieval)
  - [Conversational Recommendation](#conversational-recommendation)
  - [Clarifying Questions](#clarifying-questions)

- [6. Search-Augmented LLMs & Generative Search](#6-search-augmented-llms--generative-search)
  - [Search-Enhanced LLMs](#search-enhanced-llms)
  - [When to Retrieve](#when-to-retrieve)
  - [RAG](#rag)
    - [Knowledge Graph RAG / GraphRAG](#knowledge-graph-rag--graphrag)
    - [Agentic RAG](#agentic-rag)
    - [RAG Query Refinement](#rag-query-refinement)
    - [RAG Retrieval Optimization](#rag-retrieval-optimization)
...
- [7. Agentic Search & Deep Research](#7-agentic-search--deep-research)
  - [Agentic Search](#agentic-search)
  - [Search Agents](#search-agents)
  - [Query Planning & Decomposition](#query-planning--decomposition)
  - [Iterative Retrieval & Search](#iterative-retrieval--search)
  - [Search / Tool Use](#search--tool-use)
  - [Search as Task Solving](#search-as-task-solving)
  - [Long-Horizon Search](#long-horizon-search)
  - [Agentic RAG](#agentic-rag-1)
  - [Heterogeneous & Enterprise Agentic Search](#heterogeneous--enterprise-agentic-search)
  - [Structured Data & Database Search Agents](#structured-data--database-search-agents)
  - [Self-Improving Search Agents](#self-improving-search-agents)
  - [Deep Research](#deep-research)
  - [Deep Research Hallucination Prevention](#deep-research-hallucination-prevention)
  - [Agentic Search without External Search](#agentic-search-without-external-search)

- [8. Recommendation](#8-recommendation)
  - [Recommender Systems](#recommender-systems)
  - [Generative Recommendation](#generative-recommendation)
  - [Recommendation as Language Modeling](#recommendation-as-language-modeling)
  - [Generative Retrieval for Recommendation](#generative-retrieval-for-recommendation)
  ...
  - [Conversational Recommendation](#conversational-recommendation-1)
  - [Agentic Recommender Systems](#agentic-recommender-systems)
  - [Recommendation Foundation Models](#recommendation-foundation-models)
  - [User & Item Representation](#user--item-representation)
...
- [9. Personalization](#9-personalization)
  ...
  - [Long-Term User Interests](#long-term-user-interests)
  - [Short-Term / Session Interests](#short-term--session-interests)
  - [Preference Learning](#preference-learning)
  - [Preference Elicitation](#preference-elicitation)
  - [Memory for Personalization](#memory-for-personalization)
  - [Personalized Generation](#personalized-generation)
  - [Personalized Agents](#personalized-agents)

- [10. Discovery, Exploration & Serendipity](#10-discovery-exploration--serendipity)
  - [User Interest Exploration](#user-interest-exploration)
  - [Interest Discovery](#interest-discovery)
  - [Exploratory Search](#exploratory-search-1)
  - [Novelty](#novelty)
  - [Serendipity](#serendipity)
  - [Diversity](#diversity)
  - [Long-Tail Discovery](#long-tail-discovery)
  - [Category & Topic Discovery](#category--topic-discovery)
  - [Related-Interest Discovery](#related-interest-discovery)
  - [Proactive Recommendation](#proactive-recommendation)
  - [Preference Elicitation for Discovery](#preference-elicitation-for-discovery)
  - [Agentic Discovery](#agentic-discovery)

- [11. Multimodal & Multilingual Search / Recommendation](#11-multimodal--multilingual-search--recommendation)
  - [Multimodal Search](#multimodal-search)
  - [Multimodal Retrieval](#multimodal-retrieval-1)
  - [Multimodal Recommendation](#multimodal-recommendation-1)
  - [Vision-Language Retrieval](#vision-language-retrieval)
  - [Cross-Modal Retrieval](#cross-modal-retrieval)
  - [Multilingual Search](#multilingual-search-1)
  - [Multilingual Recommendation](#multilingual-recommendation)
  - [Cross-Lingual Retrieval](#cross-lingual-retrieval)

- [12. Document, Content & Knowledge Understanding](#12-document-content--knowledge-understanding)
  - [Document Understanding](#document-understanding-1)
  ...
  - [Entity Understanding & Linking](#entity-understanding--linking)
  - [Product / Item Understanding](#product--item-understanding)

- [13. Evaluation & Benchmarking](#13-evaluation--benchmarking)
  - [Search Engine Evaluation](#search-engine-evaluation)
  - [Retrieval Evaluation](#retrieval-evaluation)
  - [Embedding Evaluation](#embedding-evaluation-1)
  - [Ranking & Reranking Evaluation](#ranking--reranking-evaluation)
  - [Query Understanding Evaluation](#query-understanding-evaluation)
  - [Search Assistance Evaluation](#search-assistance-evaluation)
  - [Conversational Search Evaluation](#conversational-search-evaluation)
  - [RAG & QA Evaluation](#rag--qa-evaluation)
  - [Response / Answer Evaluation](#response--answer-evaluation)
  - [Factuality & Grounding](#factuality--grounding)
  - [Citation Evaluation](#citation-evaluation)
  - [Hallucination Evaluation](#hallucination-evaluation)
  - [Deep Research Evaluation](#deep-research-evaluation)
  - [Agentic Search Evaluation](#agentic-search-evaluation)
  ...
  - [Personalization Evaluation](#personalization-evaluation)
  - [Discovery & Exploration Evaluation](#discovery--exploration-evaluation)
  - [Diversity, Novelty & Serendipity Evaluation](#diversity-novelty--serendipity-evaluation)
  - [Multimodal Evaluation](#multimodal-evaluation)
  - [Question Answering Benchmarks](#question-answering-benchmarks)

- [14. Production & Industrial Search / Recommendation](#14-production--industrial-search--recommendation)
  - [Industrial Search Systems](#industrial-search-systems)
  - [Industrial Recommender Systems](#industrial-recommender-systems)
  - [Search Infrastructure](#search-infrastructure)
  - [Recommendation Infrastructure](#recommendation-infrastructure)
  - [LLM Serving](#llm-serving)
  - [Latency & Cost Optimization](#latency--cost-optimization)
  - [Online Learning & Continual Improvement](#online-learning--continual-improvement)
  - [Experimentation & A/B Testing](#experimentation--ab-testing)
  - [Human-in-the-Loop](#human-in-the-loop)
  - [Production Search Quality](#production-search-quality)

- [15. AI Scientists & Automated Search / Recommendation Engineering](#15-ai-scientists--automated-search--recommendation-engineering)
  - [AI Scientists for Search](#ai-scientists-for-search)
  - [Automated Experimentation](#automated-experimentation)
  - [Automated Model Improvement](#automated-model-improvement)
  - [Agentic Data Science](#agentic-data-science)
  - [Self-Optimizing Search Systems](#self-optimizing-search-systems)
  - [Self-Optimizing Recommender Systems](#self-optimizing-recommender-systems)

- [16. Industry Articles, Blogs & Whitepapers](#16-industry-articles-blogs--whitepapers)

- [17. Vertical Applications](#17-vertical-applications)
  - [Product & E-commerce Search](#product--e-commerce-search)
  - [Shopping & Commerce Agents](#shopping--commerce-agents)
  - [Web Search](#web-search)
  - [Maps, Local & Location-Aware Search](#maps-local--location-aware-search)
  - [Travel](#travel)
  ...
  - [MRO, Manufacturing & Supply Chain](#mro-manufacturing--supply-chain)
...
- [LLM-UP @ SIGIR 2026](https://sigir-llmup.github.io/SIGIR26-LLMUP/)
- [Multi-Agentic Recommender Systems @ SIGIR 2026](https://agenticrecsys.github.io/)
- [Agent4IR @ KDD 2026](https://sites.google.com/view/ai4ir/kdd-2026)
- [RAG4Reports @ ACL 2026](https://rag4reports.github.io/)
- [LLM & Agents for Recommendation Systems @ The Web Conference 2026](https://llmandagents4recsys.github.io/)
- [GRAIL @ CIKM 2026](https://cikm2026.diag.uniroma1.it/)
- [RecSys 2026](https://recsys.acm.org/recsys26/)
- [USRW @ RecSys 2026](https://usrw-workshop.github.io/2026/)
- [SIGIR-AP 2026](https://www.sigir-ap.org/sigir-ap-2026/)
...
- Laser: Governing Long-Horizon Agentic Search via Structured Protocol and Context Register, Dec 2025, [arxiv](https://arxiv.org/abs/2512.20458?)
- Search-o1: Agentic Search-Enhanced Large Reasoning Models, Nov 2025, [arxiv](https://aclanthology.org/2025.emnlp-main.276)
- SafeSearch: Do Not Trade Safety for Utility in LLM Search Agents, Oct 2025, [arxiv](https://arxiv.org/abs/2510.17017)
- A Comprehensive Survey on Reinforcement Learning-based Agentic Search: Foundations, Roles, Optimizations, Evaluations, and Applications, Oct 2025, [arxiv](https://arxiv.org/abs/2510.16724)
- RE-Searcher: Robust Agentic Search with Goal-oriented Planning and Self-reflection, Oct 2025, [arxiv](https://arxiv.org/abs/2509.26048)
- Towards Agentic Self-Learning LLMs in Search Environment, Oct 2025, [arxiv](https://arxiv.org/abs/2510.14253)
...
- DecoupleSearch: Decouple Planning and Search via Hierarchical Reward Modeling, Sep 2025, [arxiv](https://arxiv.org/abs/2510.21712)
- Beyond Ten Turns: Unlocking Long-Horizon Agentic Search with Large-Scale Asynchronous RL, Aug 2025, [arxiv](https://arxiv.org/abs/2508.07976)
...
- Mind2Web 2: Evaluating Agentic Search with Agent-as-a-Judge, Jun 2025, [arxiv](https://arxiv.org/abs/2506.21506)
- MaskSearch: A Universal Pre-Training Framework to Enhance Agentic Search Capability, May 2025, [arxiv](https://arxiv.org/abs/2505.20285?)
- Iterative Self-Incentivization Empowers Large Language Models as Agentic Searchers, May 2025, [arxiv](https://arxiv.org/abs/2505.20128)
...
- Q2D-Web: A Large-Scale Benchmark for Retrieval in Agentic RAG Systems,  September 2026, [arxiv](https://arxiv.org/abs/2609.08887)
- VDGR-RAG: Vectors, Directories, Graphs, and Reflection Are All You Need for Unified Reasoning over Hierarchical Enterprise Knowledge, August 2026, [arxiv](https://arxiv.org/abs/2608.07994)
- Introducing Agentic Search, Mistral AI, August 2026, [Mistral](https://mistral.ai/)
- SCAIR: Schema-Conditioned Agentic Iterative Reasoning for Enterprise Knowledge Graphs, P July 2026, [ACL Anthology](https://aclanthology.org/2026.acl-industry.76/)
- Unlocking Dependable Responses with Gemini Enterprise Agent Platform’s Agentic RAG,  Google Research, June 2026, [Google Research](https://research.google/blog/unlocking-dependable-responses-with-gemini-enterprise-agent-platforms-agentic-rag/)
- AgenticRAG: Agentic Retrieval for Enterprise Knowledge Bases, Microsoft Research, May 2026, [arxiv](https://arxiv.org/abs/2605.05538)
- Knowledge Graph RAG: Agentic Crawling and Graph Construction in Enterprise Documents, April 2026, [arxiv](https://arxiv.org/abs/2604.14220)
...
## Multi modal
- Deep-Reporter: Deep Research for Grounded Multimodal Long-Form Generation, Jul 2026, [ACL](https://aclanthology.org/2026.acl-long.1909/)
- TEMA: Anchor the Image, Follow the Text for Multi-Modification Composed Image Retrieval, Jul 2026, [ACL](https://aclanthology.org/2026.acl-long.1121/)
- VisRet: Visualization Improves Knowledge-Intensive Text-to-Image Retrieval, Jul 2026, [ACL](https://aclanthology.org/2026.acl-long.1192/)
- Zero-Shot Multimodal Retrieval with Multi-Scale Contextual Representations, Jul 2026, [ACL](https://aclanthology.org/2026.acl-long.930/)
- Progressive Multimodal Search and Reasoning for Knowledge-Intensive Visual Question Answering, Jul 2026, [ACL](https://aclanthology.org/2026.acl-long.881/)
- DORA: A Dual-Objective Reinforcement Learning Framework for Effective and Efficient Multimodal Agentic Search, Jul 2026, [ACL](https://aclanthology.org/2026.acl-long.605/)
- MMSearch-R1: Incentivizing LMMs to Search, Jul 2026, [ACL](https://aclanthology.org/2026.acl-long.114/)
- Region-R1: Reinforcing Query-Side Region Cropping for Multi-Modal Re-Ranking, Jul 2026, [ACL](https://aclanthology.org/2026.findings-acl.510/)
- MiMIC: Mitigating Visual Modality Collapse in Universal Multimodal Retrieval While Avoiding Semantic Misalignment, Jul 2026, [ACL Findings](https://aclanthology.org/2026.findings-acl.158/)
- Towards Long-horizon Agentic Multimodal Search, Apr 2026, [arxiv](https://arxiv.org/abs/2604.12890)
- VSearcher: Long-Horizon Multimodal Search Agent via Reinforcement Learning, Mar 2026, [arxiv](https://arxiv.org/abs/2603.02795)
- Scaling Beyond Context: A Survey of Multimodal Retrieval-Augmented Generation for Document Understanding, Jul 2026, [ACL](https://aclanthology.org/2026.acl-long.204/)
...
- EviRerank: Adaptive Evidence Construction for Long-Document LLM Reranking, Jun 2026, [arxiv](https://arxiv.org/abs/2411.06254)
- Reproducing Adaptive Reranking for Reasoning-Intensive IR, SIGIR 2026, Jul 2026, [paper](https://doi.org/10.1145/3805712.3808568)
- APR: Adaptive Personalised Reranking for Conversational Search, SIGIR 2026, Jul 2026, [paper](https://doi.org/10.1145/3805712.3809914)
- uva-irlab-conv at SemEval-2026 Task 8: Multi-Turn RAG with Learned Sparse Retrieval and Listwise Reranking, Jun 2026, [arxiv](https://arxiv.org/abs/2606.11945)
...
## Time Aware Search
- TimelyRAG: Semantic-Temporal Hybrid Retrieval for Time-Critical Question Answering in Overlapping-Evolving Documents, Sep 2026, [arxiv](https://arxiv.org/abs/2609.11572)
- Temporal Evidence Chain for Temporal Knowledge Graph Question Answering with Large Language Models, Jul 2026, [ACL Anthology](https://aclanthology.org/2026.acl-long.1361/)
- TDR²A: Time-sensitive decomposition-retrieval-reorganization agent for temporal knowledge graph question answering, Jun 2026, [ScienceDirect](https://www.sciencedirect.com/science/article/pii/S0957417426006317)
- Temporal-spatial reasoning over hypergraph knowledge structures for multimodal retrieval-augmented generation, Aug 2026, [Scientific Reports](https://www.nature.com/articles/s41598-026-63525-9)
- SAR: A Structure-Aligned Reasoning Framework for Temporal Knowledge Graph Question Answering, Mar 2026, [AAAI](https://ojs.aaai.org/index.php/AAAI/article/view/40369)
- Time-Aware Complex Question Answering over Temporal Knowledge Graph, Jan 2026, [ScienceDirect](https://www.sciencedirect.com/science/article/pii/S0169023X25000989)
- TempQA: An LLM-based framework for temporal knowledge graph question answering, Jan 2026, [ScienceDirect](https://www.sciencedirect.com/science/article/pii/S095070512502026X)
- It's High Time: A Survey of Temporal Question Answering, Jul 2026, [ACL Anthology](https://aclanthology.org/2026.acl-long.1332/)
- MTRM: Multi-Granularity Trend-Aware Retrieval and Modeling for Temporal Knowledge Graph Extrapolation, Jul 2026, [IEEE](https://doi.org/10.1109/TKDE.2026.3684753)
- Temporal Knowledge Graph Question Answering via Sub-Question Decomposition and Cross-Checking, Aug 2026, [IOS Press](https://journals.sagepub.com/doi/10.3233/FAIA251081)
...
## Embedding models
- UEmbed: Unified Sparse and Dense Multimodal Embeddings, Aug 2026, [arxiv](https://arxiv.org/abs/2608.02583)
- DREAM: Dense Retrieval Embeddings via Autoregressive Modeling, Jun 2026, [arxiv](https://arxiv.org/abs/2606.24667)
...
- LiteResearcher: A Scalable Agentic RL Training Framework for Deep Research Agent, Apr 2026, [arxiv](https://arxiv.org/abs/2604.17931)
- MiroThinker-1.7 & H1: Towards Heavy-Duty Research Agents via Verification, Mar 2026, [arxiv](https://arxiv.org/abs/2603.15726)
- Marco DeepResearch: Unlocking Efficient Deep Research Agents via Verification-Centric Design, Mar 2026, [arxiv](https://arxiv.org/abs/2603.28376)
- AgentIR: Reasoning-Aware Retrieval for Deep Research Agents, Mar 2026, [arxiv](https://arxiv.org/abs/2603.04384)
- SAGE: Benchmarking and Improving Retrieval for Deep Research Agents, Feb 2026, [arxiv](https://arxiv.org/abs/2602.05975)
- How to Train Your Deep Research Agent? Prompt, Reward, and Policy Optimization in Search-R1, Feb 2026. [arxiv](https://arxiv.org/abs/2602.19526)
- W&D:Scaling Parallel Tool Calling for Efficient Deep Research Agents, Feb 2026, [arxiv](https://arxiv.org/abs/2602.07359)
- MMDeepResearch-Bench: A Benchmark for Multimodal Deep Research Agents, Jan 2026, [arxiv](https://arxiv.org/abs/2601.12346)
...
- DeepResearch Bench: A Comprehensive Benchmark for Deep Research Agents, Jun 2025, [arXiv](https://arxiv.org/abs/2506.11763)
- Removal of Hallucination on Hallucination: Debate-Augmented RAG, May 2025, [arXiv](https://arxiv.org/abs/2505.18581)
- DeepResearcher: Scaling Deep Research via Reinforcement Learning in Real-world Environments, Apr 2025, [arXiv](https://arxiv.org/abs/2504.03160)
- Monitoring Decoding: Mitigating Hallucination via Evaluating the Factuality of Partial Response during Generation, Mar 2025, [arXiv](https://arxiv.org/abs/2503.03106)
- FACTCHECKMATE: Preemptively Detecting and Mitigating Hallucinations in LMs, Nov 2025, [ACL](https://aclanthology.org/2025.findings-emnlp.663/)
...
-- [Beyond 2 tower model for ranking](https://lnkd.in/g66xMwUB)
-- [Re-designing ads serving systems](https://lnkd.in/gsU4yH6s) 
-- [Non-engagement signals](https://lnkd.in/gNYnjHQ3)
-- [Offsite content understanding](https://lnkd.in/giWG4eV3)
...
## Verticals
### Product Search
- Beyond Relevance: Structured Semantic Supervision for Product Search with LLM-Augmented Annotations, Sep 2026, [arxiv](https://arxiv.org/abs/2609.23646)
- Agentic Share-of-Search: A Multi-Agent AI System for Competitive Decision-Making in LLM-Mediated E-Commerce, Sep 2026, [arxiv](https://arxiv.org/abs/2609.11190)
- From Clicks to Clips: A Multimodal Retrieval System for E-Commerce Video Recommendations, Sep 2026, [Springer](https://doi.org/10.1007/978-3-032-37685-5_24)
- ShopSimulator: Evaluating and Exploring RL-Driven LLM Agent for Shopping Assistants, Jul 2026, [ACL Anthology](https://aclanthology.org/2026.acl-long.1647/)
- Bridging Language and Items for Retrieval and Recommendation: Benchmarking LLMs as Semantic Encoders, Jul 2026, [ACL Anthology](https://aclanthology.org/2026.acl-long.147/)
- AFMRL: Attribute-Enhanced Fine-Grained Multi-Modal Representation Learning in E-commerce, Jul 2026, [ACL Anthology](https://aclanthology.org/2026.findings-acl.704/)
- Enhancing Multimodal Product Retrieval in E-Commerce by Reversing Typographic Attacks, Jun 2026, [PMLR](https://proceedings.mlr.press/v322/jenq26a.html)
- Semantic Retrieval for Product Search in E-Commerce, May 2026, [arxiv](https://arxiv.org/abs/2606.01504)
- SHOPPER: Semantic, Historical, Order-aware, and Product-conditioned Pooling for E-commerce Recommendation, 2026, [AdKDD](https://www.adkdd.org/papers/shopper%3A-semantic%2C-historical%2C-order-aware%2C-and-product-conditioned-pooling-for-e-commerce-recommendation/2026)
- ARCHER: Shooting Straight in Multimodal E-Commerce Search at Alibaba with Progressive Alignment, Apr 2026, [ACM WWW 2026](https://doi.org/10.1145/3774904.3792819)
- Hierarchical Agentic RAG Framework for Intelligent Product Discovery in Distributed E-Commerce Microservices Using MCP and Dynamic Context-Aware Vector Intelligence, Jun 2026, [IJCTT](https://doi.org/10.14445/22312803/IJCTT-V74I6P103)
...
- Spatial-RAG: Spatial Retrieval Augmented Generation for Real-World Geospatial Reasoning Questions, Jul 2026, [ACL Anthology](https://aclanthology.org/2026.findings-acl.539/)
- Reasoning Over Space: Enabling Geographic Reasoning for LLM-Based Generative Next POI Recommendation, Jul 2026, [ACL Anthology](https://aclanthology.org/2026.acl-long.332/)
- CompassLLM: A Multi-Agent Approach toward Geo-Spatial Reasoning for Popular Path Query, Jul 2026, [ACL Anthology](https://aclanthology.org/2026.findings-acl.1599/)
- MFC4POI: Multi-factor collaboration for next point-of-interest recommendation using large language models, Nov 2026, [ScienceDirect](https://www.sciencedirect.com/science/article/pii/S0306457326002153)
- Graph-Enhanced Large Language Models for Spatial Search, Jun 2026, [arxiv](https://arxiv.org/abs/2606.22909)
- Revisiting General Map Search via Generative Point-of-Interest Retrieval, May 2026, [arxiv](https://arxiv.org/abs/2605.03397)
- GeoAgentic-RAG: A Multi-Agent framework for autonomous geospatial reasoning and visual insight generation with LLM, 2026, [ScienceDirect](https://doi.org/10.1016/j.jag.2026.105195)
- Intelligent Multimodal Retrieval and Reasoning for Geospatial Knowledge Discovery on the I-GUIDE Platform, Jun 2026, [arxiv](https://arxiv.org/abs/2606.15838)
- Towards language-based retrieval of complex geospatial data: A case study on UK National geographic database, 2026, [ScienceDirect](https://doi.org/10.1016/j.jag.2026.105145)
- RALLM-POI: Retrieval-Augmented LLM for Zero-Shot Next POI Recommendation with Geographical Reranking, Apr 2026, [Springer](https://doi.org/10.1007/978-981-95-7072-0_14)
- Spatial RAG for Big Data-Driven urban itinerary recommendation, 2026, [CNR](https://iris.cnr.it/handle/20.500.14243/595641)
- TraveLLaMA: A Multimodal Travel Assistant with Large-Scale Dataset and Structured Reasoning, Mar 2026, [AAAI](https://ojs.aaai.org/index.php/AAAI/article/view/37335)
- Whose hotel does the AI recommend? An algorithm audit of reputation signals in LLM-assisted hotel selection, Jun 2026, [arxiv](https://arxiv.org/abs/2606.16344)
- Risk-Aware LLM Agents for Geospatial Data Retrieval: Design and Preliminary Adversarial Evaluation, Aug 2026, [ISPRS Archives](https://isprs-archives.copernicus.org/articles/XLIX-B3-2026/1419/2026/)
...
### Science
- Reimagining research papers as interactive and reliable AI agents, Sep 2026, [Nature](https://www.nature.com/articles/s41586-026-11044-y)
- IntrAgent: An LLM Agent for Content-Grounded Information Retrieval through Literature Review, Jul 2026, [ACL Anthology](https://aclanthology.org/2026.acl-long.29/)
- SciExplore: Evaluating Autonomous Agents from Scientific Navigation to Information Integration, Jul 2026, [ACL Anthology](https://aclanthology.org/2026.findings-acl.1117/)
- Paper Circle: An Open-source Multi-agent Research Discovery and Analysis Framework, Jul 2026, [ACL Anthology](https://aclanthology.org/2026.acl-long.1952/)
- Agentic-R: Learning to Retrieve for Agentic Search, Jul 2026, [ACL Anthology](https://aclanthology.org/2026.findings-acl.785/)
- A multi-agent system for automating scientific discovery, May 2026, [Nature](https://www.nature.com/articles/s41586-026-10652-y)
- Accelerating scientific discovery with Co-Scientist, May 2026, [Nature](https://www.nature.com/articles/s41586-026-10644-y)
- An AI system to help scientists write expert-level empirical software, May 2026, [Nature](https://www.nature.com/articles/s41586-026-10658-6)
- MAKES-QA: A multi-agent framework for knowledge graph construction and enrichment over scientific literature for question answering, Jul 2026, [ScienceDirect](https://doi.org/10.1016/j.eswa.2026.132156)
- Empowering biomedical evidence exploration and synthesis with deep knowledge graph research, Jul 2026, [Nature Machine Intelligence](https://www.nature.com/articles/s42256-026-01266-0)
- Bridging data and discovery: a survey on knowledge graphs in AI for science, Mar 2026, [National Science Review](https://academic.oup.com/nsr/article/13/8/nwag140/8507209)
- Synthesizing scientific literature with retrieval-augmented language models, Feb 2026, [Nature](https://www.nature.com/articles/s41586-025-10072-4)
- Towards end-to-end automation of AI research, 2026, [Nature](https://www.nature.com/articles/s41586-026-10265-5)
- Adaptive Mining of Scientific Knowledge Graphs via Reinforcement Learning, 2026, [ScienceDirect](https://www.sciencedirect.com/science/article/pii/S1877050926000335)
- Mapping scholarly knowledge: A systematic review of Knowledge Graphs for academic papers, 2026, [ScienceDirect](https://www.sciencedirect.com/science/article/pii/S0306457326002335)
- A Survey of Large Language Model-Based Search Agents, Jul 2026, [ACL Anthology](https://aclanthology.org/2026.acl-long.374/)
- PaSa: An LLM Agent for Comprehensive Academic Paper Search, Jan 2025, [arxiv](https://arxiv.org/abs/2501.10120)
### Finance
- FinSight: Towards Real-World Financial Deep Research, Jul 2026, [ACL Anthology](https://aclanthology.org/2026.acl-long.265/)
- FinCARDS: Card-Based Analyst Reranking for Financial Document Question Answering, Jul 2026, [ACL Anthology](https://aclanthology.org/2026.findings-acl.1244/)
- FinMRAGBench: A Realistic and Complex Benchmark for Multi-Modal RAG in Financial Document Analysis, Jul 2026, [ACL Anthology](https://aclanthology.org/2026.findings-acl.187/)
- FinSearchComp: Towards a Realistic, Expert-Level Evaluation of Financial Search and Reasoning, Apr 2026, [ICLR](https://proceedings.iclr.cc/paper_files/paper/2026/hash/4d42358702dff82e1436550a05ade260-Abstract-Conference.html)
- MimirRAG: A Multi-Agent RAG Framework for Financial Data Retrieval with Metadata Integration, May 2026, [arxiv](https://arxiv.org/abs/2605.25030)
- Agentic Retrieval-Augmented Generation for Financial Document Question Answering, May 2026, [arxiv](https://arxiv.org/abs/2605.05409)
- Measuring and Closing the Retrieval Gap in Financial Question Answering, May 2026, [PMLR](https://proceedings.mlr.press/v318/kobeissi26a.html)
- An Auditable LLM-RAG Architecture for Financial Document Intelligence and Decision Support, May 2026, [MDPI](https://www.mdpi.com/1999-5903/18/6/284)
- A Chinese financial event knowledge graph-based retrieval-augmented generation framework for financial question answering, Jul 2026, [ScienceDirect](https://www.sciencedirect.com/science/article/pii/S0952197626009528)
- HybridRAG-Finance: Agent-Guided Information Summarization with Vector and Graph Retrieval for Financial Documents, Jun 2026, [SSRN](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6923108)
- AgenticRAG: Agentic Retrieval for Enterprise Knowledge Bases, May 2026, [Microsoft Research](https://www.microsoft.com/en-us/research/publication/agenticrag-agentic-retrieval-for-enterprise-knowledge-bases/)
- Sustainable Hybrid Document-Routed Retrieval for financial RAG: Resolving the robustness-precision trade-off, Dec 2026, [ScienceDirect](https://www.sciencedirect.com/science/article/pii/S2667305326000943)
### Legal
- Legalyze: An Open-Source Structure-Aware Agentic RAG Platform for High-Precision Legal Intelligence, Sep 2026, [Wiley](https://onlinelibrary.wiley.com/doi/10.1111/exsy.70415)
- Agentic RAG for Legal Question Answering in Civil Law: Evidence From the Korean Bar Examination, Aug 2026, [IEEE](https://ieeexplore.ieee.org/document/11648184/)
- LegalGraphRAG: Multi-Agent Graph Retrieval-Augmented Generation for Reliable Legal Reasoning, Jul 2026, [ACL Anthology](https://aclanthology.org/2026.acl-long.1738/)
- LLM Agents in Law: Taxonomy, Applications, and Challenges, Jul 2026, [ACL Anthology](https://aclanthology.org/2026.acl-long.718/)
- Leverage Knowledge Graph and Large Language Model for law article recommendation: A case study of Chinese criminal law, Apr 2026, [ScienceDirect](https://www.sciencedirect.com/science/article/pii/S1570826826000053)
- LEXA: Legal case retrieval via graph contrastive learning with contextualised LLM embeddings, Mar 2026, [Springer](https://link.springer.com/article/10.1007/s11280-026-01407-w)
- Legal-DC: Benchmarking Retrieval-Augmented Generation for Legal Documents, Mar 2026, [arxiv](https://arxiv.org/abs/2603.11772)
- Legal RAG Bench: an end-to-end benchmark for legal RAG, Mar 2026, [arxiv](https://arxiv.org/abs/2603.01710)
- Benchmarking Legal RAG: The Promise and Limits of AI Statutory Surveys, Feb 2026, [arxiv](https://arxiv.org/abs/2603.03300)
- Automated data synthesis and retrieval-augmented generation for legal large language models, Jul 2026, [ScienceDirect](https://www.sciencedirect.com/science/article/pii/S0950705126009937)
...
- Beyond Maintenance Manual Multimodal RAG: Suggesting What Tool, Sep 2026, [arxiv](https://arxiv.org/abs/2609.05116)
- Agentic AI for maintenance management: a process-centric review and a staged framework for industrial adoption, Oct 2026, [ScienceDirect](https://www.sciencedirect.com/science/article/pii/S0360835226004869)
- Reducing Technician Search Burden: A Multimodal RAG for Cessna 172 Maintenance Manual, Aug 2026, [arxiv](https://arxiv.org/abs/2608.18465)
- A Multi-Agent and synergistic Knowledge Graph retrieval-augmented generation framework for intelligent maintenance, Apr 2026, [ScienceDirect](https://www.sciencedirect.com/science/article/pii/S0278612526000452)
- Automating Information Extraction and Retrieval for Industrial Spare Parts Pooling, Jun 2026, [arxiv](https://arxiv.org/abs/2606.03367)
- A topological-graph and regulation-constrained retrieval-augmented generation method for refinery and petrochemical pipeline maintenance plan generation, 2026, [ScienceDirect](https://www.sciencedirect.com/science/article/abs/pii/S0957582026005914)
- Hierarchical multi-agent reinforcement learning for retrieval-augmented industrial document question answering, Mar 2026, [Nature](https://www.nature.com/articles/s41598-026-41684-z)
- Retrieval-augmented generation enhanced LLM for industrial anomaly detection, May 2026, [Springer](https://link.springer.com/article/10.1007/s42452-026-08750-7)
- A collaborative approach based on large language model and knowledge graphs for information integration towards smart manufacturing, 2026, [ScienceDirect](https://www.sciencedirect.com/science/article/pii/S0952197626010675)
- Large language models in manufacturing: a comprehensive review, Jul 2026, [Springer](https://link.springer.com/article/10.1007/s00170-026-18711-4)
- Cache-augmented multimodal generative AI for energy-aware predictive maintenance, Aug 2026, [ScienceDirect](https://www.sciencedirect.com/science/article/pii/S0360835226003517)
- Automated Structuring and Analysis of Unstructured Equipment Maintenance Text Data in Manufacturing Using Generative AI Models, Feb 2026, [MDPI](https://www.mdpi.com/2076-3417/16/4/1969)
- Generative AI in Manufacturing and Industrial Contexts: A Systematic Review of Applications, Challenges, and Future Directions, Aug 2026, [MDPI](https://www.mdpi.com/2079-9292/15/15/3485)
